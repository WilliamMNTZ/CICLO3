...
function consultar_todo(){
    $.ajax({
        url:"https://g75e0482780f990-mybd.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/client/client",
        type:"GET",
        datatype:"json",
        ...
        success:function(json){
			...
			$("#resultado").empty();
			tabla = "<center> <table border='1'> <tr> <th>ID:</th> <th>NAME:</th> <th>EMAIL:</th> <th>AGE:</th> </tr>"
			filas = ""
...
function consultaID(codigo){
    ...
    let dataToSend=JSON.stringify(data);
	 	...
	 	$.ajax({
			...
			url:"https://g75e0482780f990-mybd.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/client/client/:id",
			type: 'GET',
			datatype:"JSON",
			data:dataToSend,
